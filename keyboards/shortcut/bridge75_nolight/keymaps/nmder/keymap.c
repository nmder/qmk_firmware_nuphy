...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_B] = LAYOUT_ansi(
        ...
        _______,	KC_AMPR,   	KC_LCBR,   	KC_RCBR,  	KC_LPRN,	KC_RPRN, 	KC_ENT,   	KC_MINUS,	KC_HASH,   	_______,  	KC_BSLS,	_______, _______,    _______,
        _______, _______, _______,                             _______,                           _______, _______,          _______, _______, _______
    ),
    ...
    [NUM] = LAYOUT_ansi(
        ...
        _______, _______, _______, _______, LWIN_T(KC_TAB), _______,	KC_H,	KC_J,	KC_K,	KC_L,	KC_BSPC, _______,          _______,          _______,
