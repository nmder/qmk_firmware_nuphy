...
const uint16_t PROGMEM combo_lbrc[] = {RWIN_T(KC_J), KC_I, COMBO_END};
...
const uint16_t PROGMEM combo_dolr[] = {KC_H, KC_I, COMBO_END};
const uint16_t PROGMEM combo_lprn[] = {KC_H, RWIN_T(KC_J), COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [WIN_B] = LAYOUT_ansi(
        ...
        LT(NUM, KC_ESC), LCTL_T(KC_A),       LSFT_T(KC_S),       LALT_T(KC_D),       LWIN_T(KC_F),       KC_G,       KC_H,       RWIN_T(KC_J),       RALT_T(KC_K),       RSFT_T(KC_L),    RCTL_T(KC_SCLN), LT(NUM, KC_QUOT),          KC_ENT,           KC_PGDN,
    ...
    [MAC_B] = LAYOUT_ansi(
        ...
        KC_VOLU, 	KC_EXLM,  	KC_UNDS,	KC_EQUAL,	KC_GRV,   	KC_TILD,   	KC_ASTR,	KC_CIRC,	KC_DLR,		KC_PERC,	KC_PLUS,   	_______,	_______,    _______, _______,
        KC_VOLD,		KC_A,	 	KC_S,		LALT_T(KC_QUOT),	KC_F,   	KC_AT,		KC_LEFT,   	KC_DOWN,   	KC_UP,   	KC_RGHT,  	KC_BSPC,   	LT(FUNC, KC_QUOT),	            _______, _______,
        KC_MUTE,	KC_MPRV,   	KC_MPLY,   	KC_MNXT,  	KC_BSLS,	KC_PIPE, 	KC_ENT,   	KC_MINUS,	KC_HASH,   	KC_TAB,  	KC_BSLS,	_______, _______,    _______,
        _______, _______, _______,                             _______,                           _______, _______,          _______, _______, _______
    ),
    ...
    [NUM] = LAYOUT_ansi(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, KC_MINUS,    KC_1,    KC_2,    KC_3,    KC_PLUS,    KC_AMPR,		KC_DQUO,   	KC_QUOT,   	KC_AT,		KC_QUES,    _______, _______, _______,          _______,
        KC_BSPC, LCTL_T(KC_BSPC),       LSFT_T(KC_4),       LALT_T(KC_5),       LWIN_T(KC_6), KC_0,	KC_LPRN,	KC_J,	KC_K,	KC_L,	RCTL_T(KC_BSPC), _______,          _______,          _______,
    ...
    [FUNC] = LAYOUT_ansi(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, _______,   KC_F1,   KC_F2,   KC_F3,   KC_F10,   _______, _______,	_______, _______, _______, _______, _______, _______,          _______,
