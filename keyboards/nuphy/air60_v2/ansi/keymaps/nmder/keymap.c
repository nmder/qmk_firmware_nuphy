...
[0] = LAYOUT(
	...
	KC_LCTL,	KC_LALT,	KC_LGUI,										LT(7, KC_SPC),   					KC_RGUI,	MO(1),   	KC_LEFT,	KC_DOWN,    KC_RGHT),
...
[7] = LAYOUT(
	...
	_______, 	_______,   	_______,   	_______,  	_______,   	C(A(KC_G)),	KC_LEFT,   	KC_DOWN,   	KC_UP,   	KC_RGHT,  	_______,   	_______,	            _______,
