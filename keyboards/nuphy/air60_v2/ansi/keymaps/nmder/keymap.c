...
[0] = LAYOUT(
	...
	LT(7, KC_ESC),		LCTL_T(KC_A),  	LSFT_T(KC_S),  	LALT_T(KC_D),	LWIN_T(KC_F),  	LT(7, KC_G),	LT(7, KC_H),	RWIN_T(KC_J),  	RALT_T(KC_K),  	RSFT_T(KC_L),	RCTL_T(KC_SCLN),	LT(7, KC_QUOT), 	            KC_ENT,
