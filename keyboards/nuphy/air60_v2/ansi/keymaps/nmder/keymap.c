...
[6] = LAYOUT(
	...
	_______,   	_______,   	_______,   	_______,  	LWIN_T(KC_TAB),	KC_AT,		KC_LEFT,   	KC_DOWN,   	KC_UP,   	KC_RGHT,  	KC_BSPC,   	_______,	            _______,
...
[7] = LAYOUT(
	...
	KC_BSPC,   	_______,   	_______,   	_______,  	_______,   	_______,	RWIN_T(KC_LPRN),	RALT_T(KC_LCBR),	RSFT_T(KC_RCBR),	RCTL_T(KC_RPRN),	KC_BSPC,   	_______,	            _______,
