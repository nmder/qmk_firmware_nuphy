...
[0] = LAYOUT(
	...
	LT(7, KC_ESC),	LCTL_T(KC_A),   	LSFT_T(KC_S),   	LALT_T(KC_D),  		LWIN_T(KC_F),   	LT(7, KC_G),   	RWIN_T(KC_H),   	RALT_T(KC_J),   	RSFT_T(KC_K),   	RCTL_T(KC_L),  		KC_SCLN,	KC_QUOT, 	            KC_ENT,
...
[6] = LAYOUT(
	...
	NM_MOD0,	KC_AMPR,   	KC_LCBR,   	KC_RCBR,  	KC_LPRN,	KC_RPRN, 	KC_ENT,   	KC_MINUS,	_______,   	_______,  	KC_BSLS,	KC_MS_BTN1, KC_MS_U,    KC_MS_BTN2,
